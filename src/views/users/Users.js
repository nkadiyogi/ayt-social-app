...
const token =
  "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJfaWQiOjcsImlhdCI6MTYyMTMyODIzMX0.oarJEHkyjvkjtemlwHNRDPEB0F0pg_D_dhCiDac9Wbo";
...
const Users = () => {
  ...
  useEffect(() => {
    console.log("useEffect component did mount[Users.js]");
    // dispatch(userActions.fetchUsers(token,7));
